...
execute as @a at @s if entity @e[type=armor_stand,tag=dungeon_restriction,distance=..150] store success score @s event_triggered run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 air replace cobblemon:healing_machine
...
execute as @a[scores={event_triggered=1..}] run give @p cobblemon:healing_machine
